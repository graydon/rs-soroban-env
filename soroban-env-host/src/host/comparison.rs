...
use soroban_env_common::{
    xdr::{
        ...
        ScContractExecutable, ScMap, ScMapEntry, ScNonceKey, ScVal, ScVec,
        TimePoint, TrustLineAsset, TrustLineEntry, Uint256, ScErrorCode, ScErrorType,
    },
...
mod tests {
    ...
    fn example_for_tag(host: &Host, tag: Tag) -> RawVal {
        ...
        let ex = match tag {
            ...
            Tag::Error => RawVal::from(Error::from(xdr::ScError::Ok)),
