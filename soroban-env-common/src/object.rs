use crate::{
    impl_wrapper_as_and_to_rawval, impl_wrapper_tryfroms_and_tryfromvals,
    impl_wrapper_wasmi_conversions, num, ConversionError, Convert, Env, RawVal, RawValConvertible,
    Symbol, Tag, TryFromVal,
};
use core::fmt::Debug;
...
impl_wrapper_tryfroms_and_tryfromvals!(Object);
...
impl Into<ScVal> for ScValObject {
    fn into(self) -> ScVal {
        self.0
    }
}
