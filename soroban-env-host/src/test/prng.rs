...
const BYTES_NEW: SymbolSmall = SymbolSmall::from_str("bytes_new");
const U64_RANGE: SymbolSmall = SymbolSmall::from_str("u64_range");
const SHUFFLE: SymbolSmall = SymbolSmall::from_str("shuffle");
const RESEED: SymbolSmall = SymbolSmall::from_str("reseed");
